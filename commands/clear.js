...

{
     ...
     let icon = message.guild.avatarURL('https://cdn.discordapp.com/emojis/469263544198889492.png?v=1')
    ...
    return message.channel.send(`He eliminado los mensajes por ti! ${.setThumbnail(icon)}`)
